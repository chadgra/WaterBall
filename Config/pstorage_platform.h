 ...
 * @file
 *
 * @defgroup pstorage platform header.
 * @{
 * @ingroup application
 *
 * @brief pstorage platform interface.
 ...
 * This was copied from an implementation originally found in an SDK example.
 */
...
#define PSTORAGE_CMD_QUEUE_SIZE     16                                                          /**< Maximum number of flash access commands that can be maintained by the module for all applications. Configurable. */
